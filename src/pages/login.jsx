...
return (
    ...
    <form className="logincontainer h-[600px] w-[420px] bg-slate-500 absolute top-[100px] right-[200px] rounded-xl ">
    <img src='../images/containerbg.jpg' className='h-[100%] w-full absolute inset-0 rounded-xl' alt='containerbg'/>
        ...
        <div className="inputs flex flex-col justify-center items-center relative h-full w-full">
            ...
            placeholder='Username' className='inputfield w-[300px] h-[50px] rounded-xl p-4 mt-12'/>

            <input type="password" onChange={(e)=>setPassword(e.target.value)} value={password}
            placeholder='Password'  className='inputfield w-[300px] h-[50px] rounded-xl p-4 mt-10'/>

            <Link to="/Home"> <button type='submit' className='bg-bgdeepTurquoise h-[50px]  w-[100px] rounded-xl text-orange font-sans mt-10'>Login</button></Link>
