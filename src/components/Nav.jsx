...
cursor-pointer flex justify-center items-center font-serif'> Blogs</h1>
    ...
    <div className={`  absolute min-h-[30vh] left-0 top-[90%] w-full p-5 flex flex-col md:static md:flex bg-blacklite md:bg-transparent md:min-h-fit md:w-auto gap-9 text-sm ${isNavOpen ? 'block' : 'hidden'}`}>
